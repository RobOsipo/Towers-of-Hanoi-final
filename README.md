...
# to win you MUST get move the stack from your original starting column to the middle one, stacked exaclty how its stacked in the starting column at the game start, from the largest piece on bottom and stack up with the blocks in order of largest to smallest.

#--The logic for the game is described in psuedo code throughout the main.js file where youll find the source code of the game logic.
#--The index.js file, used for creating a GUI, also has psuedo code explaining what different blocks of the code are doing.
