...
function printStacks(){
 ...
 //this function is for moving pieces and is called if the move is legal 
function movePiece(token, startStack, endStack){
  
 
  // This will pop out the last piece from the startStack array 
  startStack.pop(token); 
  
  // This  will push that last piece to the endStack array 
  endStack.push(token); 
...
function isLegal(startStack, endStack){
  ...
  // This takes away the white space and any case-sensitivity issues
